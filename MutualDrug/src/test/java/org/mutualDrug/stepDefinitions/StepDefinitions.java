package org.mutualDrug.stepDefinitions;

import org.junit.Assert;
import org.junit.Test;
import org.mutualDrug.pages.HomePage;
import org.mutualDrug.pages.LogIn_Page;
...
public class StepDefinitions extends BaseClass {
	...
	public void user_should_be_navigated_to_apllication_homepage() {
		...
		Assert.assertEquals("https://mdmembersdev.azurewebsites.net/admin/members/sign-in", currentUrl);
	...
	public void user_clicks_on_details() {
		...
		Assert.assertEquals("https://mdmembersdev.azurewebsites.net/admin/members/details",title);
	}
}
